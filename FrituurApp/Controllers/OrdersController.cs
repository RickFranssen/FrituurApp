...
namespace FrituurApp.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,OrderDate,OrderTotal,CustomerID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,OrderDate,OrderTotal,CustomerID")] Order order)
        {
            if (id != order.OrderID)
            {
                return NotFound();
